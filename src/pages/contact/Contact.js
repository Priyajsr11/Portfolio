            ...
            <Jumbotron className="contact-jumbotron">
                <Row>
                    <Col className="d-flex justify-content-center flex-wrap">
                        <div className="m-2">
                            <a href="mailto:priyajsr65@gmail.com" target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="m-2">
                            <a href="https://www.facebook.com/profile.php?id=100007034741476" target="_blank" rel="noopener noreferrer">
